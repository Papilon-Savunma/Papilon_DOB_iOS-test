...
Papilon_DOB_iOS-test is available through [CocoaPods](https://cocoapods.org). To install
...
//            logoImageName: "amazon",
            fontType: .poppinsRegular,
            // for prefilled form fields
            name: "Yasin",
            surname: "Köker",
